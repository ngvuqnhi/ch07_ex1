...
<div class="container">
    <div class="card">
        <div class="header">
            <h1>Downloads</h1>
            <div class="sub">Joe Rut – Genuine Wood Grained Finish</div>
        </div>
        ...
        <table class="table" role="table" aria-label="Downloadable tracks">
            ...
            <tr>
                <td>Filter</td>
                <td>
                    <a href="${pageContext.request.contextPath}/sound/${productCode}/filter.mp3">MP3</a>
                </td>
            </tr>
            <tr>
                <td>So Long Lazy Ray</td>
                <td>
                    <a href="${pageContext.request.contextPath}/sound/${productCode}/so_long.mp3">MP3</a>
                </td>
            </tr>
            </tbody>
        </table>
