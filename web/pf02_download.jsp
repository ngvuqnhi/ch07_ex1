...
<div class="container">
    <div class="card">
        <div class="header">
            <h1>Downloads</h1>
            <div class="sub">Paddlefoot – The Second CD</div>
        </div>
        ...
        <table class="table" role="table" aria-label="Downloadable tracks">
            ...
            <tr>
                <td>Neon Lights</td>
                <td>
                    <a href="${pageContext.request.contextPath}/sound/${productCode}/neon.mp3">MP3</a>
                </td>
            </tr>
            <tr>
                <td>Tank Hill</td>
                <td>
                    <a href="${pageContext.request.contextPath}/sound/${productCode}/tank.mp3">MP3</a>
                </td>
            </tr>
            </tbody>
        </table>
